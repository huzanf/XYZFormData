 ...
 * Gravity Forms tables this dashboard reads (gf_form / gf_form_meta /
...
// ---------------------------------------------------------------------
// Form 1: Main Form (accounting intake)
// ---------------------------------------------------------------------

$pdo->prepare('INSERT INTO gf_form (id, title) VALUES (1, ?)')->execute(['Main Form']);

$mainFormMeta = [
    'fields' => [
        ['id' => 1, 'label' => 'Client Name', 'type' => 'text', 'inputs' => []],
        ['id' => 2, 'label' => 'Category', 'type' => 'select', 'inputs' => []],
        ['id' => 3, 'label' => 'Amount', 'type' => 'text', 'inputs' => []],
...
$eventFormMeta = [
    'fields' => [
        ...
        ['id' => 5, 'label' => 'Ticket Price', 'type' => 'text', 'inputs' => []],
    ],
];
...
$attendees = [
    ...
    'Laura Franklin', 'Tomás García', 'Nadia Haddad', 'Kevin Ito', 'Olivia Johnson',
    'David Kline', 'Emily Lawson', 'Marcus Nguyen', 'Sofia Pearson',
];
...
foreach ($attendees as $i => $name) {
    ...
    // Each attendee joins 1-3 events, so several show up under multiple event groups.
