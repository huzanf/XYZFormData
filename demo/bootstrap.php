 ...
 * app's public/*.php pages expect, but pointed at demo data instead of a
 * live WordPress MySQL database. No portal password is set here, so
 * Auth::requireLogin() no-ops (see src/Auth.php).
 */
